...
## Data Sources
There are two datasets that we are using in this project: the HIV testing locations dataset and the HIV/AIDS Diagnoses by Neighborhood, Sex, and Race/Ethnicity dataset. Both datasets are available on NYC Open Data. 
